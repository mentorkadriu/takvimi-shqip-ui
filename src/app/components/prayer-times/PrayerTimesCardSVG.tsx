...
export default function PrayerTimesCardSVG({
  prayerTimes,
  currentTime,
  isToday,
}: PrayerTimesCardSVGProps) {
  ...
  const svgData = useMemo(() => {
    ...
    const sortedPrayers = [...prayerTimesInMinutes].sort(
      ...
      prayers: sortedPrayers.map((prayer) => ({
        ...
        isCurrent:
          ...
          ((prayer.minutesSinceMidnight <= currentTimeInMinutes &&
            ...
            sortedPrayers[sortedPrayers.indexOf(prayer) + 1].minutesSinceMidnight >
    ...
    <div className="mb-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 border border-gray-100 dark:border-gray-700">
      ...
      <div className="relative h-24">
        ...
        {svgData.prayers.map((prayer) => (
          <div key={prayer.name} className="absolute top-0" style={{ left: `${prayer.position}%` }}>
            {/* Icon */}
            <div
